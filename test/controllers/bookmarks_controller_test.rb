...
class BookmarksControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create bookmark" do
    assert_difference('Bookmark.count') do
      post bookmarks_url, params: { bookmark: { link_name: @bookmark.link_name, paste_url: @bookmark.paste_url } }
    end
  ...
  test "should update bookmark" do
    patch bookmark_url(@bookmark), params: { bookmark: { link_name: @bookmark.link_name, paste_url: @bookmark.paste_url } }
